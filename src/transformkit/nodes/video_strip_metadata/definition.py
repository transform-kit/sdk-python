"""video.strip-metadata node definition.

Strip container/tag metadata from a video buffer via lossless stream copy.
...
video_strip_metadata = NodeDefinition(type="video.strip-metadata", execute=_execute)
